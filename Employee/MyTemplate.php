                        ...
                        <div class="collapse navbar-collapse navbar-right" id="bs-example-navbar-collapse-1">
                            <nav class="menu menu--iris">
                                <ul class="nav navbar-nav menu__list">
                                    <li class="menu__item "><a href="dashboard.php" class="menu__link">List</a></li>
                                    <li class="menu__item"><a href="feed.php" class="menu__link">Feedback</a></li>
                                    <li class="menu__item"><a href="request.php" class="menu__link">Request</a></li>
                                    <li class="menu__item"><a href="logout.php" class="menu__link">Log-in/out</a></li>
                                </ul>
                            </nav>
                        </div>
                    </nav>
